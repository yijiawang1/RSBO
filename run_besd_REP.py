...
from multifidelity_KG_REP.voi.optimization_sep import *
from multifidelity_KG_REP.model.hyperparameter_optimization_sep import optimize_hyperparameters, \
                                                                        create_array_points_sampled_noise_variance, \
                                                                        compute_hyper_prior
from multifidelity_KG_REP.misokg_utils_sep import process_parallel_results, load_sample_data
from multifidelity_KG_REP.misokg_utils_sep import sample_initial_x_uniform, select_startpts_x_BFGS
from multifidelity_KG_REP.misokg_utils_sep import sample_initial_f1f2_closer_f1_further_f2, select_startpts_f1closer_BFGS
from multifidelity_KG_REP.misokg_utils_sep import sample_initial_f1f2_higher_f1_lower_f2, select_startpts_f1higher_BFGS
...
argv = sys.argv[1:]
'''
python run_misoKG_REP.py miso_mc 0 0 mcf1
    - benchmark_name
        + miso_gw -- gw10One1, gw10Two1, gw10Two2, gw10Three1; gw20Three1, gw20Three2
        + miso_ky -- ky10One
        + miso_it -- it10
        + miso_pd -- pd10
        + miso_mc -- mcf2, mcf3
...
init_result_path = folder+'initResults_miso_'+prob_name+'/rep'+str(problem.replication_no)+'/'
exp_path = init_result_path+'initial_samples/'
result_folder = folder+'Results_miso_'+prob_name
